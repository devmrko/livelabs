#!/usr/bin/env python3
"""
Workshop Text Scraper
Web scraper for extracting workshop data from Oracle LiveLabs website
Provides automated data collection with pagination and content parsing
"""
...
class WorkshopTextScraper:
    """Web scraper for Oracle LiveLabs workshop content extraction"""
    ...
    def scrape_all_pages(self, max_pages=100):
        ...
        try:
            ...
            logger.info("Starting workshop text scraping...")
    ...
    def print_summary(self):
        ...
        self.workshop_parser.print_workshop_summary(self.all_workshops, "WORKSHOP TEXT SCRAPING SUMMARY")

def main():
    """Main function to run workshop text scraping"""
    # Create scraper (set save_to_mongo=True to also save to MongoDB)
    scraper = WorkshopTextScraper(headless=True, save_to_mongo=False)
